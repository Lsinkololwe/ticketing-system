...
/**
 * Payout Review Status Enum
 *
 * Defines the review status for payout requests requiring attention.
 */
public enum PayoutReviewStatus {
    ...
    PayoutReviewStatus(String code, String displayName, String description) {
        this.code = code;
    ...
    public static PayoutReviewStatus fromCode(String code) {
        for (PayoutReviewStatus status : values()) {
